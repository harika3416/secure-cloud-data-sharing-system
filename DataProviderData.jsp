    ...
    <div id="templatemo_right_column">
        ...
        <div id="templatemo_content_wrapper">
        	...
        	<div id="templatemo_content">
              ...
              <tr>
                <td width="87" height="31" bgcolor="#FF0000"><div align="center" class="style2"><span class="style5">User ID </span></div></td>
                <td width="155" bgcolor="#FF0000"><div align="center" class="style2"><span class="style5">File Name </span></div></td>
				<td width="161" bgcolor="#FF0000"><div align="center" class="style2"><span class="style5">Provider Name </span></div></td>
                <td width="190" bgcolor="#FF0000"><div align="center" class="style2"><span class="style5">Date &amp; Time</span></div></td>
              </tr>
              <%
	...
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                <td height="29"><div align="center" class="style3"><%=i%></div></td>
